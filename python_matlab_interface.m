function path_final = python_matlab_interface(n, src, dest)
I1 = imread(strcat('simulation_data/180sec_vid1/img', num2str(n),'.png'));
I2 = imread(strcat('simulation_data/180sec_vid2/img', num2str(n),'.png'));
I4 = imread(strcat('simulation_data/180sec_vid4/img', num2str(n),'.png'));
I5 = imread(strcat('simulation_data/180sec_vid5/img', num2str(n),'.png'));
